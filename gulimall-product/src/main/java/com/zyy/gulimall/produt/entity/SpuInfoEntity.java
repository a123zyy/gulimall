...
public class SpuInfoEntity implements Serializable {
	...
	public SpuInfoEntity(Long id, String spuName, String spuDescription, Long catalogId, Long brandId, BigDecimal weight, Integer publishStatus, Date createTime, Date updateTime) {
		this.id = id;
